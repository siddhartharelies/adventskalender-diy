// netlify/functions/checkDoor7.js
...
exports.handler = async (event) => {
  ...
  const mode = (body.mode || "open").toLowerCase(); // "check" oder "open"
   ...
   // 1) Passwort für Tür 7 (Lösung aus Tür 6)
...
const isCorrect = validPasswords.includes(entered);
  ...
  // 2) Mindestdatum für das Öffnen von Tür 7
  const minDate = "2025-12-07"; // im Format YYYY-MM-DD
